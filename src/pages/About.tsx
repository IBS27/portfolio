        ...
        <div className="code-card">
          <pre className="terminal-copy" aria-label="About code snippet">
            <code>
              ...
              <span className="code-line"><span className="line-number">5</span>  <span className="token-property">stack</span><span className="token-punctuation">:</span> <span className="token-punctuation">[</span><span className="token-string">'Python'</span><span className="token-punctuation">,</span> <span className="token-string">'TypeScript'</span><span className="token-punctuation">,</span> <span className="token-string">'Dart'</span><span className="token-punctuation">,</span> <span className="token-string">'Solana'</span><span className="token-punctuation">,</span> <span className="token-string">'React'</span><span className="token-punctuation">,</span> <span className="token-string">'Next.js'</span><span className="token-punctuation">]</span><span className="token-punctuation">,</span></span>
              <span className="code-line"><span className="line-number">6</span>  <span className="token-property">tools</span><span className="token-punctuation">:</span> <span className="token-punctuation">[</span><span className="token-string">'vLLM'</span><span className="token-punctuation">,</span> <span className="token-string">'Modal'</span><span className="token-punctuation">,</span> <span className="token-string">'FastAPI'</span><span className="token-punctuation">,</span> <span className="token-string">'Firebase'</span><span className="token-punctuation">,</span> <span className="token-string">'Flutter'</span><span className="token-punctuation">]</span><span className="token-punctuation">,</span></span>
              <span className="code-line"><span className="line-number">7</span>  <span className="token-property">interests</span><span className="token-punctuation">:</span> <span className="token-punctuation">[</span><span className="token-string">'F1'</span><span className="token-punctuation">,</span> <span className="token-string">'Film'</span><span className="token-punctuation">,</span> <span className="token-string">'Basketball'</span><span className="token-punctuation">,</span> <span className="token-string">'Ping Pong'</span><span className="token-punctuation">,</span> <span className="token-string">'Marvel Rivals'</span><span className="token-punctuation">,</span> <span className="token-string">'Ballroom Dancing'</span><span className="token-punctuation">]</span></span>
              <span className="code-line"><span className="line-number">8</span><span className="token-punctuation">{'}'};</span></span>
            </code>
          </pre>
        </div>
        ...
        <div className="code-card">
          <pre className="terminal-copy" aria-label="Philosophy markdown snippet">
            <code>
              ...
              <span className="code-line"><span className="line-number">11</span><span className="token-string">from the real world. I'm especially interested in how small, well-composed models can outperform</span></span>
              <span className="code-line"><span className="line-number">12</span><span className="token-string">monolithic ones when you give them the right tools and feedback loops.</span></span>
            </code>
          </pre>
        </div>
      </div>
